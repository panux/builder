...
func (pg *PackageGenerator) InitializeVars(mv MakeVars, b *makefile.Builder) {
	//put notice
	b.Comment().
		Line("Section autogenerated by PackageGenerator.InitializeVars (see godoc.org/gitlab.com/panux/builder/pkgen)").
		Line("DO NOT EDIT")
...
func (pg *PackageGenerator) GenMake(mv MakeVars, b *makefile.Builder) {
	//put notice
	b.Comment().
		Line("Section autogenerated by PackageGenerator.GenMake (see godoc.org/gitlab.com/panux/builder/pkgen)").
		Line("DO NOT EDIT")
...
func (pg *PackageGenerator) GenFullMakefile(mv MakeVars) *makefile.Builder {
	...
	//put notice
	b.Comment().
		Line("Makefile autogenerated by PackageGenerator.GenFullMakefile (see godoc.org/gitlab.com/panux/builder/pkgen)").
		Line("DO NOT EDIT")
	b.BlankLine()
